...
func (s *nguoiDungService) UpdateNguoiDung(maNguoiDung int, nd models.NguoiDung) error {
	...
	// Cập nhật trực tiếp các trường địa chỉ (cho phép chuỗi rỗng là giá trị hợp lệ)
	nguoiDungCu.TinhThanh = sql.NullString{String: nd.TinhThanh.String, Valid: nd.TinhThanh.Valid}
	nguoiDungCu.QuanHuyen = sql.NullString{String: nd.QuanHuyen.String, Valid: nd.QuanHuyen.Valid}
	nguoiDungCu.PhuongXa = sql.NullString{String: nd.PhuongXa.String, Valid: nd.PhuongXa.Valid}
	nguoiDungCu.DuongSoNha = sql.NullString{String: nd.DuongSoNha.String, Valid: nd.DuongSoNha.Valid}
...
func (s *nguoiDungService) UpdateNguoiDungAdmin(maNguoiDung int, nd models.NguoiDung) error {
	...
	// Cập nhật MaQuyen nếu khác 0 (giữ nguyên quy tắc hiện tại)
	if nd.MaQuyen != 0 {
