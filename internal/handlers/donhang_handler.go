...
// logUpdateDonHang - Hàm log thông tin cập nhật đơn hàng
func (h *DonHangHandler) logUpdateDonHang(donHang *models.DonHang) {
	fmt.Printf("[DEBUG] Cập nhật đơn hàng - ID: %d, Phương thức thanh toán: %s, Tổng tiền: %.2f, Trạng thái: %s\n",
		donHang.MaDonHang, donHang.PhuongThucThanhToan, donHang.TongTien, donHang.TrangThai)
}
